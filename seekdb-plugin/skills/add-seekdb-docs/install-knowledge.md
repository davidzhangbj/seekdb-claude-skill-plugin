# Install seekDB Knowledge to Project - Agent Workflow

**When to use**: When the user wants to add OceanBase seekDB's best practices reference links to their project's AI documentation.

**Required parameter**: `SKILL_NAME` (e.g., "seekdb-core", "seekdb-sql", "seekdb-python-sdk", "seekdb-all")
...
Your AI assistant can now reference these seekDB best practices in future conversations by following the URLs. The documentation includes:
- Connection patterns and configuration
- SQL syntax and query examples
...
Note: I'll automatically reference these resources when you ask about seekDB topics.
${end if}
...
- Suggest checking file permissions or skill installation
- Exit workflow
...
Setup is complete! Would you like me to add seekDB best practices reference links to your project?
